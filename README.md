...
- [x] **Change Allowed Classes**: Add a setting so that only a specific set of "allowed classes" (as determined by the game's referee) are available to select in the character form.
