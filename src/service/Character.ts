...
export class Character {
	...
	constructor(name: string, level: number, char_class: string, xp_mod: number, pc: boolean) {
		this.name = name
		this.level = level
...
export class NPC extends Character {
	...
	constructor(name: string, level: number, char_class: string, xp_mod: number, wage: number, wage_coin: string, share: string) {
